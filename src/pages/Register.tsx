    ...
    <div className="w-full h-screen bg-[#F8FAFC] flex font-sans overflow-hidden">
      ...
      <div className={`w-full ${step === 3 ? 'w-full px-4 md:px-16' : 'lg:w-1/2 px-6 sm:px-12 md:px-20'} py-12 flex flex-col justify-center bg-white relative`}>
        ...
        <div className={`mx-auto w-full ${step === 3 ? 'max-w-5xl' : 'max-w-md'} flex flex-col items-center`}>
          {/* Brand Logo Header */}
          <img src={Logo} alt="Enactus Logo" className="h-12 object-contain mb-6" />
            ...
            {step === 2 && (
              <div className="w-full">
                <div className="text-center mb-5">
                  ...
                  <p className="text-gray-400 text-xs">Source quality waste materials for your production needs</p>
                </div>
                ...
                >
                  <svg className="w-4 h-4" viewBox="0 0 24 24">
                    <path fill="#EA4335" d="M12 5.04c1.64 0 3.12.56 4.28 1.67l3.2-3.2C17.52 1.58 14.96 1 12 1 7.35 1 3.42 3.67 1.52 7.56l3.77 2.93c.9-2.7 3.4-4.45 6.71-4.45z"/>
                    <path fill="#4285F4" d="M23.49 12.27c0-.81-.07-1.59-.2-2.35H12v4.46h6.44c-.28 1.47-1.11 2.71-2.36 3.55l3.67 2.84c2.15-1.98 3.74-4.9 3.74-8.5z"/>
                    <path fill="#FBBC05" d="M5.29 14.51c-.23-.69-.36-1.43-.36-2.2s.13-1.51.36-2.2L1.52 7.18C.55 9.12 0 11.3 0 13.62s.55 4.5 1.52 6.44l3.77-2.93z"/>
                    <path fill="#34A853" d="M12 23c3.24 0 5.97-1.07 7.96-2.91l-3.67-2.84c-1.02.68-2.33 1.09-4.29 1.09-3.31 0-5.81-1.75-6.71-4.45L1.52 16.82C3.42 20.71 7.35 23 12 23z"/>
                  </svg>
                  Sign with Google
                </button>
                ...
                <div className="space-y-4 mb-6 text-left">
                  <div>
                    <label className="block text-xs font-medium text-gray-600 mb-1.5">Full name / Businesss Name</label>
                    <input 
                      type="text" 
                      name="fullName" 
                ...
                <button type="submit" className="w-full bg-[#16A34A] hover:bg-[#15803D] text-white font-medium py-3 px-4 rounded-lg transition-colors text-sm">
                  Continue
                </button>
              </div>
            )}
